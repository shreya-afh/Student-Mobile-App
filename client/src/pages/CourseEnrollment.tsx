    ...
    <div className="h-screen bg-[#faf9fb] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="max-w-md mx-auto">
          ...
          {showCourse && (
            <Card className="border-[#6d10b0] mb-6">
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge className="bg-[#eff1ff] text-[#6d10b0] border-transparent hover:bg-[#eff1ff]">
                    Digital Marketing
                  </Badge>
                </div>
                  ...
                  <ul className="space-y-1">
                    {[
                      ...
                      <li key={i} className="font-['Inter',Helvetica] font-normal text-[#495565] text-sm flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6d10b0]"></span>
                        {module}
                      </li>
                    ))}
                  </ul>
                ...
                <Button
                  ...
                  className="w-full h-12 bg-[#6d10b0] hover:bg-[#5a0d94] text-white rounded-lg font-['Inter',Helvetica] font-medium text-base mt-4"
                >
                  Enroll Now
                </Button>
              </CardContent>
            ...
            <CardContent className="p-4">
              ...
              <ul className="space-y-1">
                {[
                  ...
                  <li key={i} className="font-['Inter',Helvetica] font-normal text-[#495565] text-sm flex items-center gap-2">
                    <span className="text-[#6d10b0]">•</span>
                    {item}
                  </li>
                ))}
              </ul>
